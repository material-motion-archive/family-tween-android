...
/**
 * Interpolate a {@link TweenProperty} on a view from one value to another.
 */
public class Tween<V> extends BaseTween<View, V> {
  ...
  @Override
  protected Class<? extends Performer<View>> getPerformerClass() {

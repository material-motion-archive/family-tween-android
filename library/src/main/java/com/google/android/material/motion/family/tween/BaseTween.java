 ...
 */
public abstract class BaseTween<T, V> extends Plan<T> {
  ...
  /**
   * Initializes an BaseTween plan for the given property with the values as the keyframes.
   * <p>
   ...
   */
  @SafeVarargs
  protected BaseTween(TweenProperty<? super T, V> property, long duration, @NonNull V... values) {
